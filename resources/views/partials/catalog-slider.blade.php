    ...
    <div class="container">
        ...
        <div class="slider-container">
            ...
            <div class="catalog-scroll-wrapper" id="catalogWrapper">
                ...
                // PASTIKAN MENGGUNAKAN 'uploads' DI SINI
                $imgSrc = ($sepeda->Gambar_Sepeda && file_exists(public_path('uploads/' . $sepeda->Gambar_Sepeda)))
                ? asset('uploads/' . $sepeda->Gambar_Sepeda)
                : asset('images/slider/1.jpg');
                @endphp

                {{-- SINTAKS ERROR ADA DI BARIS INI JIKA ANDA MENAMBAH TANDA SEMICOLON (;) --}}
